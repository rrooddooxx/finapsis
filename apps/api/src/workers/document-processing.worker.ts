...
import { documentAnalyzerService } from '../features/assistant-financial-documents/document-analyzer.service';
      ...
      const analysisResult = await documentAnalyzerService.analyzeDocument({
        ...
        config: {
          features: [
            ...
            ...(data.includeTableExtraction !== false ? [{ type: 'TABLE_EXTRACTION' as const, maxResults: 20 }] : []),
          ],
