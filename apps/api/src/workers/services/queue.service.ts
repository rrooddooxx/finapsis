...
export class QueueService {
  private documentUploadQueue: Queue<DocumentUploadJobData>;
  private documentAnalysisQueue: Queue<DocumentAnalysisJobData>;
  private documentCompletedQueue: Queue<DocumentProcessingCompletedJobData>;
