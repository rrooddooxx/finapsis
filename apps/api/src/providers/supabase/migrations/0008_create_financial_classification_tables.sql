...
CREATE TYPE "public"."processing_stage" AS ENUM('DOCUMENT_UPLOAD', 'OCR_EXTRACTION', 'DOCUMENT_CLASSIFICATION', 'TEXT_ANALYSIS', 'LLM_VERIFICATION', 'TRANSACTION_CREATION', 'CONFIDENCE_SCORING', 'FINAL_VALIDATION');
